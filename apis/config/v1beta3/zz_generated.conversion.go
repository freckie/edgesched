...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*EdgeScoringArgs)(nil), (*config.EdgeScoringArgs)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1beta3_EdgeScoringArgs_To_config_EdgeScoringArgs(a.(*EdgeScoringArgs), b.(*config.EdgeScoringArgs), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*config.EdgeScoringArgs)(nil), (*EdgeScoringArgs)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_config_EdgeScoringArgs_To_v1beta3_EdgeScoringArgs(a.(*config.EdgeScoringArgs), b.(*EdgeScoringArgs), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*EdgeScoringTarget)(nil), (*config.EdgeScoringTarget)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1beta3_EdgeScoringTarget_To_config_EdgeScoringTarget(a.(*EdgeScoringTarget), b.(*config.EdgeScoringTarget), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*config.EdgeScoringTarget)(nil), (*EdgeScoringTarget)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_config_EdgeScoringTarget_To_v1beta3_EdgeScoringTarget(a.(*config.EdgeScoringTarget), b.(*EdgeScoringTarget), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1beta3_EdgeScoringArgs_To_config_EdgeScoringArgs(in *EdgeScoringArgs, out *config.EdgeScoringArgs, s conversion.Scope) error {
	out.Targets = *(*[]config.EdgeScoringTarget)(unsafe.Pointer(&in.Targets))
	return nil
}

// Convert_v1beta3_EdgeScoringArgs_To_config_EdgeScoringArgs is an autogenerated conversion function.
func Convert_v1beta3_EdgeScoringArgs_To_config_EdgeScoringArgs(in *EdgeScoringArgs, out *config.EdgeScoringArgs, s conversion.Scope) error {
	return autoConvert_v1beta3_EdgeScoringArgs_To_config_EdgeScoringArgs(in, out, s)
}

func autoConvert_config_EdgeScoringArgs_To_v1beta3_EdgeScoringArgs(in *config.EdgeScoringArgs, out *EdgeScoringArgs, s conversion.Scope) error {
	out.Targets = *(*[]EdgeScoringTarget)(unsafe.Pointer(&in.Targets))
	return nil
}

// Convert_config_EdgeScoringArgs_To_v1beta3_EdgeScoringArgs is an autogenerated conversion function.
func Convert_config_EdgeScoringArgs_To_v1beta3_EdgeScoringArgs(in *config.EdgeScoringArgs, out *EdgeScoringArgs, s conversion.Scope) error {
	return autoConvert_config_EdgeScoringArgs_To_v1beta3_EdgeScoringArgs(in, out, s)
}

func autoConvert_v1beta3_EdgeScoringTarget_To_config_EdgeScoringTarget(in *EdgeScoringTarget, out *config.EdgeScoringTarget, s conversion.Scope) error {
...
// Convert_v1beta3_EdgeScoringTarget_To_config_EdgeScoringTarget is an autogenerated conversion function.
func Convert_v1beta3_EdgeScoringTarget_To_config_EdgeScoringTarget(in *EdgeScoringTarget, out *config.EdgeScoringTarget, s conversion.Scope) error {
	return autoConvert_v1beta3_EdgeScoringTarget_To_config_EdgeScoringTarget(in, out, s)
}

func autoConvert_config_EdgeScoringTarget_To_v1beta3_EdgeScoringTarget(in *config.EdgeScoringTarget, out *EdgeScoringTarget, s conversion.Scope) error {
	out.NodeName = in.NodeName
	out.IP = in.IP
	out.Port = in.Port
	return nil
...
// Convert_config_EdgeScoringTarget_To_v1beta3_EdgeScoringTarget is an autogenerated conversion function.
func Convert_config_EdgeScoringTarget_To_v1beta3_EdgeScoringTarget(in *config.EdgeScoringTarget, out *EdgeScoringTarget, s conversion.Scope) error {
	return autoConvert_config_EdgeScoringTarget_To_v1beta3_EdgeScoringTarget(in, out, s)
}
...
func autoConvert_v1beta3_NodeResourceTopologyMatchArgs_To_config_NodeResourceTopologyMatchArgs(in *NodeResourceTopologyMatchArgs, out *config.NodeResourceTopologyMatchArgs, s conversion.Scope) error {
	// WARNING: in.ScoringStrategy requires manual conversion: inconvertible types (*github.com/freckie/edgesched/apis/config/v1beta3.ScoringStrategy vs github.com/freckie/edgesched/apis/config.ScoringStrategy)
...
func autoConvert_config_NodeResourceTopologyMatchArgs_To_v1beta3_NodeResourceTopologyMatchArgs(in *config.NodeResourceTopologyMatchArgs, out *NodeResourceTopologyMatchArgs, s conversion.Scope) error {
	// WARNING: in.ScoringStrategy requires manual conversion: inconvertible types (github.com/freckie/edgesched/apis/config.ScoringStrategy vs *github.com/freckie/edgesched/apis/config/v1beta3.ScoringStrategy)
